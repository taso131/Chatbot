...
def calculations_for_new_customer(amount_to_buy) -> float:
    if amount_to_buy < 2:
        ...
        first_one_50_off = product_cost * float(promotions_dictionary['first_order_50_off'])
        not_qualified_amount = amount_to_buy - 1    
        left_ones_25_off = (not_qualified_amount * product_cost) * float(promotions_dictionary['first_order_rest_25_off'])
